                    ...
                    <div class="intro_video_iner text-center">
                        ...
                        <div class="intro_video_icon">
                            <a id="play-video_1" class="video-play-button popup-youtube"
                                ...
                                <source src="photographer\img\2.mp4" type="photographer\img">
                            </a>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-between">
                ...
                <div class="col-sm-6 col-md-6 col-lg-3">
                    <div class="single-footer-widget footer_icon">
                        <h4>Contact Info</h4>
                        <p>A2 Chuong Duong , Da Nang, Vietnamese
                            postcode: 550000</p>
                        <ul>
                            <li><a href="#"><i class="ti-mobile"></i>0236.113</a></li>
                            <li><a href="#"><i class="ti-email"></i>photograpphy@gmail.com</a></li>
                            <li><a href="#"><i class="ti-world"></i>chongbuonnguoi@gmail.com</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-sm-6 col-md-6 col-lg-3">
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="ti-heart" aria-hidden="true"></i> by <a href="https://colorlib.com" target="_blank">Minh Duc</a>
